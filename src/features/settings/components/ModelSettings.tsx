      ...
      models: [
        {
          ...
          context: '128K',
          description: 'Advanced research capabilities with chat completion',
          tier: 'Pro'
        },
        {
          ...
          context: '128K',
          description: 'Fast online search with reasoning capabilities',
          tier: 'Pro'
        },
        {
          ...
          context: '128K',
          description: 'Standard reasoning with search capabilities',
          tier: 'Pro'
        },
        {
          ...
          name: 'Sonar Pro',
          context: '200K',
          description: 'Advanced reasoning with integrated search and larger context',
          tier: 'Pro'
        },
        {
          ...
          name: 'Sonar',
          context: '128K',
          description: 'Standard chat completion with search capabilities',
          tier: 'Pro'
        }
      ]
    }
